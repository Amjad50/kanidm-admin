...
pub fn router() -> Router<AppState> {
    Router::new()
        ...
        .route("/groups/{id}", get(detail::redirect_to_overview).post(edit::submit))
        ...
        .route("/groups/{id}/members/purge-modal", get(members::purge_modal))
        ...
        .route("/groups/{id}/policy/{field}/reset", post(policy::reset_field))
        .route("/groups/{id}/edit", get(edit::edit_form))
        .route("/groups/{id}/delete", get(delete::show).post(delete::submit))
}
