...
mod tests {
    ...
    #[test]
    fn remaining_less_than_a_minute() {
        let now = datetime!(2026-05-15 12:00:00 UTC);
        let t = datetime!(2026-05-15 12:00:30 UTC);
        assert_eq!(format_relative_remaining_at(t, now), "less than a minute");
    }

    #[test]
    fn remaining_one_minute() {
        let now = datetime!(2026-05-15 12:00:00 UTC);
        let t = datetime!(2026-05-15 12:01:00 UTC);
        assert_eq!(format_relative_remaining_at(t, now), "1 minute");
    }
    ...
    #[test]
    fn remaining_one_hour() {
        let now = datetime!(2026-05-15 12:00:00 UTC);
        let t = datetime!(2026-05-15 13:00:00 UTC);
        assert_eq!(format_relative_remaining_at(t, now), "1 hour");
    }
    ...
    fn remaining_days() {
        let now = datetime!(2026-05-15 12:00:00 UTC);
        let t = datetime!(2026-05-18 12:00:00 UTC);
        assert_eq!(format_relative_remaining_at(t, now), "3 days");
    }
    ...
    fn remaining_months() {
        let now = datetime!(2026-05-15 12:00:00 UTC);
        let t = datetime!(2026-08-15 12:00:00 UTC);
        assert_eq!(format_relative_remaining_at(t, now), "3 months");
    }
}
